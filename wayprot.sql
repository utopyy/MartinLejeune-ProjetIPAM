...
(1,'France','Paris','3000','Joncs','3B','user',0),
(2,'Belgique','Nivelles','1400','Paquette','10','admin',0),
(32,'ezfz','zf','e','fze','efz','user3',1),
(33,'zefz','okok','1500','3','20','controller.php',1),
(34,'efz','ef','ef','ok','fez','controller',0),
(35,'FEZ','fez','efz','zfz','2',' controller',0);
...
(1,'DISQUE MUSCULATION ATHLITECH FONTE 5KG','Fonte compatible avec les barres GO Sport. Diametre : 2.8 cm Poids : 5 kg ',16,1,'public/img/mat/p1.jpg',0),
(2,'DISQUE MUSCULATION ATHLITECH FONTE 10KG','Fonte compatible avec les barres GO Sport. Diametre : 2.8 cm Poids : 10 kg ',15,1,'public/img/mat/p2.jpg',0),
...
(4,'HALTERES MUSCULATION ATHLITECH HALTERE 10 KG','Pour bien commencer la musculation chez soi. Idéal pour muscler le haut du corps : épaules, biceps, triceps, dorsaux et pectoraux. Compatible avec les barres GO Sport. Composition : 4 disques de 1 kg, 2 disques de 2 kg, 2 stops disques pour des barres de ',19,2,'public/img/mat/p4.jpg',0),
(5,'HALTERES MUSCULATION ATHLITECH HALTERE 15 KG','Pour bien commencer la musculation chez soi. Idéal pour muscler le haut du corps : épaules, biceps, triceps, dorsaux et pectoraux. ',25.99,2,'public/img/mat/p5.jpg',0),
(6,'MUSCULATION EVERLAST EQUIPMENT EVERLAST EQUIPMENT NECK DEVELOPER','Accessoires entrainement Poids Everlast Equipment Neck Developer. Caractéristiques:- Bluetooth montre Smart Watch Phone - 1.3Mp Caméra Sync Appel SMS Passometer, Fitness Tracker, sommeil Tracker, un message Rappel, Rappel dappel, répondre é un appel, comp',41.24,2,'public/img/mat/p6.jpg',0),
(7,'FITNESS AVENTO KTTLEBELL 41KG 1KG NEOPRENE','Avec ce kettlebell d\'Avento, vous serez en mesure de renforcer vos muscles de manière sûre et efficace. ',19.08,2,'public/img/mat/p7.jpg',0),
(8,'PURE2IMPROVE SAC DE FORCE 10KG','Ce sac de force de 10 kg de la marque pure2improve est l\'accessoire idéal pour un entraînement corporel total ! ',78.56,2,'public/img/mat/p8.jpg',0),
(9,'PURE2IMPROVE SAC DE FORCE 5KG','Ce sac de force de 5 kg de la marque pure2improve est l\'accessoire idéal pour un entraînement corporel total ! ',72.52,2,'public/img/mat/p9.jpg',0),
(10,'MUSCULATION EVERLAST EQUIPMENT CROSS TRAINING KIT','Accessoires entrainement poids everlast equipment cross training kit. Caractéristiques:- bluetooth montre smart watch phone - 1.3mp caméra sync appel sms passometer, fitness tracker, sommeil tracker, un message rappel, rappel dappel, répondre à un appel, ',280.45,2,'public/img/mat/p10.jpg',0),
(11,'PURE2IMPROVE CEINTURE D\'HALTEROPHILIE L','Cette ceinture d\'haltérophilie de pure2improve soutiendra efficacement le bas de votre dos pendant les flexions des jambes et les soulevés de terre ! ',47.12,2,'public/img/mat/p11.jpg',0),
(12,'JULIUS K9 HALTERES EN BOIS DUR 1KG','Fabriqué en bois dur disponible en différentes tailles et formes durable quantité : 1 modèle : 26200e référence fabricant : 26200e type : divers fabricant : k9-sport kft. ',41.01,2,'public/img/mat/p12.jpg',0),
...
(14,'FITNESS SVLETUS RACK MEDECINE BALL','Parfait pour ranger et stocker les médecine balls. 20 broches. Capacité : 10 pièces. Vendu sans médecine ball. Charge maximale : 80 kg. ',289.78,3,'public/img/mat/p14.jpg',0),
(15,'FITNESS TREMBLAY CT MEDECINE BALL 1,5KG','Medecine ball tremblay 1,5 kg en pvc ',32.99,3,'public/img/mat/p15.jpg',0),
...
(17,'CHAUSSETTES FEMME SOFTWR INV FINE F','Pack de 3 paires de chaussettes SOFTwr pour Femme. Fines et invisibles. ',4.99,4,'public/img/mat/p17.jpg',0),
(18,'SHAKER MUSCULATION NUTRITION','Shaker classique qui mélangera facilement vos protéines. ',5.99,4,'public/img/mat/p18.jpg',0),
(19,'MODE HOMME NIKE H86 METAL SWOOSH','Accessoires homme casquettes et chapeaux nike h86 metal swoosh. La casquette réglable nike metal swoosh h86 présente une fermeture à clip personnalisable à larrière',38.31,4,'public/img/mat/p19.jpg',0),
(20,'BANC ABDOS MUSCULATION ATHLITECH ABDOGO TWO II','2 en 1 : cette planche abdo sert aussi de banc de musculation sans chandelle.Siège capitonné avec un renfort de fessiers.',69.99,5,'public/img/mat/p20.jpg',0),
(21,'BANC ABDOS MUSCULATION ATHLITECH BENCH COMPACT','Rembourage en mousse assise pour un confort optimal revêtement simili cuir pour un entretien facile. Fonctions: Au moins 8 excercices possibles grâce à ce banc de musculation.',99.99,5,'public/img/mat/p21.jpg',0),
...
(60,'o','fze',8,1,'public/img/logo.png',1),
(62,'a','fozefu',2,11,'public/img/logo.png',1),
(63,'a','fe',0.03,1,'public/img/logo.png',1),
(64,'a','EFZ',2,1,'public/img/logo.png',1),
(65,'ef','ezfz',2,2,'public/img/logo.png',1),
(66,'abd','rfe',2,7,'public/img/logo.png',1),
(67,'ef','oko',2,5,'public/img/logo.png',1),
(68,'IMPACT EAA','zsf',2,5,'public/img/logo.png',1),
(69,'BLBAL 2','ok',2,15,'public/img/logo.png',1),
(70,'MUSCU','ze',3,5,'public/img/logo.png',1),
(71,'OKOKO','ed',2,5,NULL,0),
(72,'OK','oko',2,5,'public/img/',0),
(73,'ABCA','ok',2,5,'public/img/banner-img.png',0),
(74,'AAAAA','cze',2,5,'public/img/upload/banner-img.png',0),
(75,'AVIDEOK','er',8,5,'public/img/upload/p1.jpg',0),
(76,'JEVEUX','efz',2,11,'public/img/upload/coucou.jpg',0);
...
(1,'user','Michel','Sardou','1984-04-02','michmich@gmail.com','$2y$10$vNA3CGRccwU2phAHlVVFLufANg9Kor3yAHoM2dMAhfyWgP2cstC1C',1,'2020-04-15','2020-04-15',0),
(2,'admin','Michel','Angelo','1995-04-07','miaden@gmail.com','$2y$10$b4GnWwHbZZStEyen00JBsO5x4wZr52QeBvgLUP2Ev6zh6Pxo4.4bi',2,'2020-04-15','2020-04-15',0),
(41,'user3','efz','zef','2020-04-17','efz@fe.c','$2y$10$ZP5iXEHEbQFW1HvnGZXfc.gqeOwbWgbGPW6KDhq/nJRI6/B7jXP4y',1,'2020-04-27','2020-04-27',1),
(42,'controller.php','fez','zefz','2020-04-13','cont@gmail.com','$2y$10$9jx7wYNqRGskafXIh/87BOdQRNnVCtTBljcyDnAq6z60camimHfVC',1,'2020-04-29','2020-04-29',1),
(43,'controller','fez','f','2020-03-31','ui@gmail.ce','$2y$10$RJiKvGnxDn9hkDQAwmL4deC5Puarnv3t6gKrXWnVHbWYcM6ElD/sW',1,'2020-04-29','2020-04-29',0),
(44,' controller','dz','zd','2020-04-08','dz@gmail','$2y$10$.VUZFx3UJiaWl9GDdRUkrOfbABPyvQ3lH4TS3he/574.TZCxZ1C52',1,'2020-04-29','2020-04-29',0);
